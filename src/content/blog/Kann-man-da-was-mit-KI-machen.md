...
| Interne Wissensdatenbank mit KI aufbauen      | IT, HR, Unternehmensleitung | Erstellen Sie eine interne KI-gestützte Wissensdatenbank, die auf Anfragen von Mitarbeitern antworten kann.   | Mit zum Beispiel **Zilliz** eine Wissensdatenbank entwickeln, die auf NLP basiert.           | [Zilliz](https://zilliz.com/) |
| Automatisiertes Lead-Scoring implementieren   | Vertrieb, Marketing       | Automatisieren Sie die Bewertung und Priorisierung von Leads für eine effizientere Vertriebsstrategie.       | Nutzen Sie **HubSpot AI** oder **Salesforce Einstein**, um Lead-Scoring zu automatisieren.          | [HubSpot](https://www.hubspot.de/) |

<h6> Was wird nach einer Woche erreicht?</h6> 
...
| KI-gestütztes Dokumentenarchiv implementieren | Unternehmensleitung, IT   | Entwickeln Sie ein Archiv, das alle Unternehmensdokumente KI-gestützt durchsucht und relevante Informationen findet. | Mit **RAG-Modellen** (z.B. über **Zilliz**) ein automatisches Dokumentenarchiv erstellen.         | [Zilliz entdecken](https://zilliz.com/) |
...
| <h6>Aufgabe</h6>                              | <h6>Abteilung</h6>       | <h6>Beschreibung</h6>                                                                                          | <h6>Beispiel</h6>                                                                                        | <h6>Links zum Ausprobieren</h6> |
|-------------------------------------------------|--------------------------|------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------|---------------------------|
