...
author: "Carsten Hof"
tags: ["Daten", "Strategie", "Automatisierung"]
draft: false
...
Ein modernes Stammdatenmanagement (MDM) setzt auf ein Prinzip, das in vielen Unternehmen fehlt: Einheitlichkeit mit klarer Verantwortlichkeit.
...
Wir erleben in Projekten häufig die Sorge, dass ein professionelles MDM-Projekt zu groß, zu teuer, zu kompliziert ist. Deshalb starten wir pragmatisch:
...
Der Clou: Es braucht nicht sofort ein teures MDM-Tool. Ein zentral gepflegtes Repository kann schon enormen Mehrwert bringen.

### 📊 Stammdaten vs. Bewegungsdaten

| **Kriterium**              | **Stammdaten**                                                | **Bewegungsdaten**                                            |
|---------------------------|---------------------------------------------------------------|---------------------------------------------------------------|
| **Definition**            | Grundlegende, dauerhaft gültige Informationen                 | Ereignisbezogene, zeitlich veränderliche Informationen        |
...
Ein Entity-Relationship-Diagramm (ER-Diagramm) hilft dabei, die Welt der Stammdaten greifbar zu machen. Es zeigt auf einen Blick, welche „Dinge“ (z. B. Produkte, Kunden, Maschinen) im Unternehmen wichtig sind – und wie sie miteinander in Beziehung stehen.
