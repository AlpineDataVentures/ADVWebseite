...
benefits:
  - title: "Gesetzliche Pflicht erfüllt"
    text: "Die Benennung ist formal korrekt, dokumentiert und der Aufsichtsbehörde gemeldet. Im Prüfungsfall oder bei Anfragen Betroffener gibt es einen klaren Ansprechpartner."
  - title: "Dokumentation, die aktuell bleibt"
    text: "Neue Systeme, neue Prozesse, neue Mitarbeiter: der DSB stellt sicher, dass die Datenschutzdokumentation Schritt hält und keine neuen Lücken entstehen."
  - title: "Datenschutz, der im Unternehmen verankert ist"
    text: "Regelmäßige Schulungen, frühzeitige Einbindung bei neuen Projekten und jährliche Reviews sorgen dafür, dass Datenschutz nicht nur auf dem Papier existiert."
  - title: "Entlastung der Geschäftsführung"
    text: "Der DSB übernimmt die operative Betreuung aller Datenschutzthemen und berichtet regelmäßig, damit die Geschäftsführung den Überblick behält und Datenschutz nicht untergeht."
contact:
  author_id: "ben-diez"
