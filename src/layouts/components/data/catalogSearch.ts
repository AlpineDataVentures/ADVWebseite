...
const searchSynonyms: Record<string, string[]> = {
  ...
  datenschutz: ["dsgvo", "privacy", "governance", "datenschutzbeauftragter", "dsb"],
  dsgvo: ["datenschutz", "privacy"],
  datenschutzbeauftragter: ["dsb", "externer dsb", "datenschutz", "tüv", "retainer"],
  dsb: ["datenschutzbeauftragter", "externer dsb", "datenschutz"],
  tüv: ["datenschutzbeauftragter", "zertifiziert", "dsb"],
  retainer: ["monatlich", "laufend", "betreuung", "datenschutzbeauftragter"],
